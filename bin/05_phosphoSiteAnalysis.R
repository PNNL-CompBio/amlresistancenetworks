...
#amlresistancenetworks::plotSingleProtein(gene='CPT1A',gilt.pdat,'phosphorylation')
#amlresistancenetworks::plotSingleProtein(gene='CUL5',gilt.pdat,'phosphorylation')
