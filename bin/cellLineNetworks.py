...
syn.login()
data = syn.tableQuery("SELECT * FROM syn23004114").asDataFrame()
...
def main():
    ...
    beta = 0.5
    proteomics_dictionary = significant_prots(data, 'Sample', 'Gene', 'LogFoldChange')
    ...
    tab = table.build_table("Cell line PanCan Network Distances", 'syn22128879', res)
    syn.store(tab)
