...
logr.preds%>%ggplot(aes(x=numFeatures,y=MSE,col=Molecular))+geom_point()+scale_color_viridis_d()+ggtitle("Logistic Regression Predictor Performance")


reg.preds%>%ggplot(aes(x=numFeatures,y=MSE,col=Molecular))+geom_point()+scale_color_viridis_d()+ggtitle("LASSO Regression Predictor Performance")
```
